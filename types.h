...
namespace vrt {
	...
	public:
		...
		Vector3(T val) : x(val), y(val), z(val) { DCHECK(!HasNaNs()); }
	...
	public:
		...
		Point2<T> Lerp(const Point2f &t) const {
			return Point2<T>(vrt::Lerp(t.x, pMin.x, pMax.x),
				vrt::Lerp(t.y, pMin.y, pMax.y));
		}
	...
	public:
		...
		Point3<T> Lerp(const Point3f &t) const {
			return Point3<T>(vrt::Lerp(t.x, pMin.x, pMax.x),
				vrt::Lerp(t.y, pMin.y, pMax.y),
				vrt::Lerp(t.z, pMin.z, pMax.z));
		}
		//返回p以pMin为原点，以包围盒三轴为坐标轴的相对坐标
